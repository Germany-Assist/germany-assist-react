...
export const ServiceCard = ({ service }) => {
    const defaultImage = "https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60";
    ...
    return (
        <div className="flex-shrink-0 w-72 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 bg-white mx-2">
            ...
            <div className="p-4">
                <h3 className="font-bold text-lg text-gray-800 mb-1 line-clamp-2">{service.title}</h3>
                ...
                <div className="flex justify-between items-center mt-3">
                    <div className="flex items-center">
                        ...
                        <span className="text-gray-600 text-sm">({service.total_reviews || 250})</span>
                    </div>
                    <span className="text-red-500 font-bold">${service.price?.toFixed(2) || "49.99"}</span>
                </div>

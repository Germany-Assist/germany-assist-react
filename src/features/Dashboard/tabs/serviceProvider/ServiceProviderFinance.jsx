...
const ServiceProviderFinance = () => {
  ...
  //         <div
  //           className={`p-2 rounded-xl ${order.dispute ? "bg-red-500/10 text-red-500" : "bg-zinc-100 dark:bg-zinc-800 text-zinc-400"}`}
  //         >
  //           {order.dispute ? <Gavel size={16} /> : <History size={16} />}
  //         </div>
  //         <div>
  ...
  //     render: (order) => (
  //       <p
  //         className={`text-xl font-black italic tracking-tighter ${order.dispute ? "text-red-500" : "text-blue-600 dark:text-blue-400"}`}
  //       >
  ...
  //         {order.status === "active" && (
  //           <>
  //             <button className="px-4 py-2 border border-zinc-200 dark:border-white/10 text-[10px] font-black uppercase rounded-xl">
  //               Cancel
  //             </button>
  //             <button
  //               onClick={() => handleCloseOrder(order.orderId)}
  //               className="px-4 py-2 bg-zinc-900 dark:bg-white dark:text-black text-white text-[10px] font-black uppercase rounded-xl"
  //             >
